<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="商品ID" align="center" prop="typeId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="商品类型" prop="typeName">
          <el-input v-model="form.typeName" placeholder="请输入商品类型" />
        </el-form-item>
      </el-form>
...
<script>
import { listType, getType, delType, addType, updateType } from "@/api/shopping/productType"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除商品类别编号为"' + typeIds + '"的数据项？').then(function() {
